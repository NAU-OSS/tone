...
If you feel that another community member has violated the code of conduct, please reach out to one of the project maintainers with a description of who violated the code of conduct, which sentiment was violated, and an explanation of how it was violated.

## Consequences
Contributors found to be in violation of the code of conduct will receive one of the following consequences in alignment with the extent of their violation:
- a warning with a reference to the type of violation
- temporary suspension as a contributor
- permanent removal as a contributor
